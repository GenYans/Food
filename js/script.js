...
const deadLine = '2023-03-22T16:16:00';
    ...
    function postData(form) {
        form.addEventListener('submit', (e) => {
            ...
            const object = {}; /* Обьект, для преобразования в JSON с помощью метода перебора */
            formData.forEach(function(value, key) {
                object[key] = value;
            });
            const json = JSON.stringify(object); /* Преврящает обычный обьект в JSON */
            request.send(json);
